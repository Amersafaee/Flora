...
class _UpcomingTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Stream all tasks for calendar markers
        ...
        return ListView(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                isToday ? "Today's Tasks" : _formatHeaderDate(selectedDay),
                style: TextStyle(
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      isToday ? 'Your plants are happy and healthy.' : 'No tasks scheduled for this day.',
...
class _TaskCard extends StatelessWidget {
  ...
  Color get _iconColor {
    switch (task.type) {
      ...
      case 'repot':     return const Color(0xFF795548); // brown
      case 'mist':      return Colors.lightBlue;
      default:          return Colors.blue; // water
    }
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (task.plantNickname.isNotEmpty)
                    Text(task.plantNickname, style: const TextStyle(
                      fontSize: 13, color: AppColors.moss,
                    )),
                ],
              ),
            ),
  ...
  Future<void> _complete(BuildContext context) async {
    ...
    if (context.mounted) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text('$_label done! ✅ Next task scheduled.'),
    ...
    return StreamBuilder(
      ...
      builder: (context, snap) {
          ...
          return const Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 12),
                Text('No completed tasks yet', style: TextStyle(color: AppColors.moss)),
              ],
            ),
          );
        }
        ...
        for (final t in tasks) {
          final key = _dateKey(t.completedAt ?? t.dueDate);
