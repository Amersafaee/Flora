...
void main() {
  group('Flora Screen Smoke Tests', () {
    ...
    testWidgets('FloraScreen can be built without throwing', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
      await tester.pump(const Duration(seconds: 3));
      expect(find.byType(FloraScreen), findsOneWidget);
    });
    ...
    testWidgets('Send button is enabled when text is entered', (WidgetTester tester) async {
      ...
      await tester.enterText(find.byType(TextField), 'Hello Flora');
