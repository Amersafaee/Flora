...
void main() {
  group('Flora Context Service Tests', () {
    ...
    test('Context string always ends without being cut mid-word if truncated', () {
      ...
      // Current implementation in flora_context_service.dart just uses substring(0, 1500), which may cut mid-word!
