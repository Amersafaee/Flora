...
const Map<String, String> labelToKey = {
  ...
  'Point your camera and Flora names it': 'cameraFloraNames',
  'Flora reminds you exactly when to care': 'floraRemindsWhenToCare',
  ...
  'Ask Flora anything': 'askFloraAnything',
  'Type a message': 'typeAMessage',
  'Flora is thinking': 'floraIsThinking',
  'New Chat': 'newChat',
  ...
  'Analyze with Flora': 'analyzeWithFlora',
  'Identifying': 'identifying',
  'Add to My Collection': 'addToMyCollection',
  'Analyze Another': 'analyzeAnother',
  'Continue with Flora': 'continueWithFlora',
